本利用規約（以下「本規約」といいます。）は、XXX 株式会社（以下「当社」といいます。）がで提供するサービス「talentify」（名称を変更する場合には名称変更後のサービスを含め、以下「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
